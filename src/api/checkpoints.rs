...
use crate::api::client::endpoints::checkpoints::{BY_HASH, BY_NUMBER, NUMBER};
...
impl Client {
    ...
    ///     println!("Checkpoint number: {}", checkpoint.header.number);
    ///
    ///     Ok(())
    /// }
    /// ```
...
mod tests {
    use super::*;
    use crate::types::{CheckpointHeader, CheckpointTransactions};
    ...
    fn test_checkpoint_structure() {
        ...
        let checkpoint = Checkpoint {
            header: CheckpointHeader {
                ...
                state_root: "0x18b2b9746b15451d1f9bc414f1c12bda8249c63d4a46926e661ae74c69defd9a"
                    .to_string(),
                transactions_root:
                    "0xa1e7ed47e548fa45c30232a7e7dfaad6495cff595a0ee1458aa470e574f3f6e4".to_string(),
        ...
        assert_eq!(checkpoint.header.number, deserialized.header.number);
        assert_eq!(checkpoint.header.hash, deserialized.header.hash);
        assert_eq!(checkpoint.header.timestamp, deserialized.header.timestamp);
