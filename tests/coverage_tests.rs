...
fn test_crypto_functions() {
    ...
    let address_result = private_key_to_address(private_key).unwrap();
    ...
    let owner = Address::from_str("0x742d35Cc6634C0532925a3b8D91D6F4A81B8Cbc0").unwrap();
    let token = Address::from_str("0x1234567890abcdef1234567890abcdef12345678").unwrap();
...
fn test_utils_functions() {
    ...
    let wallet = wallet::EvmWallet::generate_random().unwrap();
